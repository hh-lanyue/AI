...
from tools.time_tool import get_stand_time
...
def buy_pre_get_queue_count_data_get():
    ...
    seat_type = config_data['custom']['seat_type']
    train_date = config_data['custom']['train_date']
    queue_count_data = {}
    try:
        queue_count_data['REPEAT_SUBMIT_TOKEN'] = global_token
        queue_count_data['train_date'] = get_stand_time(train_date)
        ...
        queue_count_data['seatType'] = seat_type
